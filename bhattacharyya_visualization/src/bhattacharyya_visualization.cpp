...
CostVis::CostVis()
 ...
 , mean_2_x_("mean_2_x", -10.0f, 0.1f, 10.0f, 1.0f)
 , mean_2_y_("mean_2_y", -10.0f, 0.1f, 10.0f, 1.0f)
 , mean_2_z_("mean_2_z", -10.0f, 0.1f, 10.0f, 1.0f)

 , cov_1_xx_("cov_1_xx", 0.0, 0.001, 2.0, 1.0)
 , cov_1_yy_("cov_1_yy", 0.0, 0.001, 2.0, 1.0)
 , cov_1_zz_("cov_1_zz", 0.0, 0.001, 2.0, 1.0)
 , cov_1_xy_("cov_1_xy", -2.0, 0.001, 2.0, 0.0)
 , cov_1_xz_("cov_1_xz", -2.0, 0.001, 2.0, 0.0)
 , cov_1_yz_("cov_1_yz", -2.0, 0.001, 2.0, 0.0)

 , cov_2_xx_("cov_2_xx", 0.0, 0.001, 2.0, 1.0)
 , cov_2_yy_("cov_2_yy", 0.0, 0.001, 2.0, 1.0)
 , cov_2_zz_("cov_2_zz", 0.0, 0.001, 2.0, 1.0)
