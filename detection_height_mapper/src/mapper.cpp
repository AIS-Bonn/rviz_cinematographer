...
void Mapper::processPointCloud(const InputPointCloud::ConstPtr &input_cloud)
{
   ...
   height_image.processMedianFiltered(*obstacle_points, transform);
   height_image.processObstaclesWithTransform(*obstacle_points, transform, m_height_image_obstacle_thresh(), m_height_image_obstacle_odds_hit(), m_height_image_obstacle_odds_miss(), m_height_image_obstacle_clamp_thresh_min(), m_height_image_obstacle_clamp_thresh_max());
