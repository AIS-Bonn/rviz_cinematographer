...
Some [remarks](rviz_cinematographer_gui#remarks) for this use case are added after the tutorial section. 
...
More details to recording videos are provided [below](rviz_cinematographer_gui#recording-parameters). 
